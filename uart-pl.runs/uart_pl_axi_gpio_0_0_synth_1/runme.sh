...
HD_PWD='C:/Users/darkr/Documents/vivadoProjects/uart-pl/uart-pl.runs/uart_pl_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_pl_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_pl_axi_gpio_0_0.tcl
