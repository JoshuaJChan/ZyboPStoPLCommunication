...
HD_PWD='C:/Users/darkr/Documents/vivadoProjects/uart-pl/uart-pl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_pl_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_pl_wrapper.tcl
