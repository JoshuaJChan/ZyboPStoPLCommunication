...
HD_PWD='C:/Users/darkr/Documents/vivadoProjects/uart-pl/uart-pl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_pl_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_pl_wrapper.tcl -notrace
